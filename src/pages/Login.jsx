    ...
    <div className="login-container">
      ...
      <div className="login-wrapper">
        ...
        <div className="login-card">
          ...
          {/* BOTÓN GOOGLE (estilizado como el resto, con el botón real de Google
              superpuesto e invisible para mantener el flujo oficial de OAuth) */}
          <div className="google-btn-wrapper">
            <button type="button" className="btn-google" disabled={loading} tabIndex="-1">
